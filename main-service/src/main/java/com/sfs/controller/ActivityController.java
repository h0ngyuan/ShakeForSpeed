...
public class ActivityController {
    ...
    public Result joinActivity(@RequestBody ActivityInfoDTO activityInfoDTO) throws Exception {
        return activityService.joinActivity(activityInfoDTO);
    }

    @GetMapping("/exitActivity")
    public void exitActivity(@RequestBody ActivityInfoDTO activityInfoDTO){
         activityService.exitActivity(activityInfoDTO);
